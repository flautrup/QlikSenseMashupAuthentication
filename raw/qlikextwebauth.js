    ...
    function before() {
        ...
        xhr.onload = function (ev) {
            ...
            if (answer.userId) {
                ...
                document.getElementById('status').innerText = answer.session;
            }
        }
        xhr.open('GET', 'http://rd-flp-51.rdlund.qliktech.com/db/qps/user?targetUri=http://rd-flp-51.rdlund.qliktech.com/db/content/PersonalAPI/mashupredirectexample.html');
        //xhr.open('GET', 'http://rd-flp-51.rdlund.qliktech.com/db/qps/user?targetUri=http://rd-flp-51.rdlund.qliktech.com:3000/index.html');
        xhr.send();
    }
    before();
}
